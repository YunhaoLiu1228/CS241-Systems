...
**Scheduled**: 10-30-20 19:59:00  
**Revision**: dda0243ec87d7e6c56945a73795151ad70207352  
**Score**: **10.6** out of **27.0** points
...
Trying to compile your code...
Successfully compiled your code.
Too slow! :( (took: 5.062s, limit: 3.25s)
...
Successfully compiled your code.
Could not find output in correct order (or extra printouts?)
Too slow! :( (took: 4.066s, limit: 3.25s)
```
---
...
Trying to compile your code...
Successfully compiled your code.
Good performance! (took: 1.299s, limit: 1.5s)
