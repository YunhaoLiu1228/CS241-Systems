...
**Scheduled**: 09-27-20 23:36:00  
**Revision**: 1ee6f229352b49c9b1f8ca21678082ee3c57504d  
...
==191==    at 0x401B02: shell (in /tmp/tmpl0sim1od/shell)
==191==    by 0x401F25: main (in /tmp/tmpl0sim1od/shell)
==191== 
==191== 
==191== HEAP SUMMARY:
==191==     in use at exit: 112 bytes in 2 blocks
==191==   total heap usage: 4 allocs, 2 frees, 8,304 bytes allocated
==191== 
==191== LEAK SUMMARY:
==191==    definitely lost: 0 bytes in 0 blocks
==191==    indirectly lost: 0 bytes in 0 blocks
==191==      possibly lost: 0 bytes in 0 blocks
==191==    still reachable: 112 bytes in 2 blocks
==191==         suppressed: 0 bytes in 0 blocks
==191== Reachable blocks (those to which a pointer was found) are not shown.
==191== To see them, rerun with: --leak-check=full --show-leak-kinds=all
==191== 
...
==191== ERROR SUMMARY: 1 errors from 1 contexts (suppressed: 0 from 0)
```
---
...
```
Unsuccesfully handled the kill <pid> command.
```
---
...
1a3318616de393436c8afc701a40f3d78f3ce0a0 shell.c
