...
**Scheduled**: 09-28-20 21:41:00  
**Revision**: 3ae8e6e9d5342723c03785234c2a2cafedc4bf4e  
...
==192==    at 0x402112: shell (in /tmp/tmp5b0migx1/shell)
==192==    by 0x402535: main (in /tmp/tmp5b0migx1/shell)
==192== 
==192== 
==192== HEAP SUMMARY:
==192==     in use at exit: 224 bytes in 4 blocks
==192==   total heap usage: 6 allocs, 2 frees, 8,416 bytes allocated
==192== 
==192== LEAK SUMMARY:
==192==    definitely lost: 0 bytes in 0 blocks
==192==    indirectly lost: 0 bytes in 0 blocks
==192==      possibly lost: 0 bytes in 0 blocks
==192==    still reachable: 224 bytes in 4 blocks
...
87db1f4be4b99880313678dc0ade33b8d68dd346 shell.c
